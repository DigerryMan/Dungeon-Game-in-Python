...
class Maggot(Enemy):
    ...
    def merge_into_one_frame(self):
        ...
        if self.facing == Directions.DOWN:
            self.frame.blit(
                self.head_frame,
                (
                    (self.MOB_SIZE - self.head_frame.get_width()) // 2,
                    (self.MOB_SIZE) * 0.3,
                ),
            )
            ...
            self.frame.blit(
                self.head_frame,
                (
                    self.MOB_SIZE * 0.65 - self.head_frame.get_height() // 2,
                    (self.MOB_SIZE - self.head_frame.get_height()) // 2 + 2,
                ),
            )
    ...
    def set_head_frame(self):
        ...
        self.head_frame = pygame.transform.scale(
            self.head_frame, (self.MOB_SIZE * 0.75, self.MOB_SIZE * 0.75)
        )
