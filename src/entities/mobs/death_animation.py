...
class DeathAnimator():
    ...
    def prepare_death_images(self):
        ...
        for x in range(12):
            ...
            self.death_images.append(pygame.transform.scale(image_help, (death_mob_size, death_mob_size)))       
    ...
    def prepare_death_images_for_fly(self):
        ...
        for y in range(1, 4):
            for x in range(4):
                image_help = self.enemy.img.subsurface(pygame.Rect(x * death_mob_size, y * death_mob_size, death_mob_size, death_mob_size))
                self.death_images.append(pygame.transform.scale(image_help, (self.enemy.MOB_SIZE, self.enemy.MOB_SIZE)))       
